  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: "#FAF9F7" }}>
      <div className="w-full flex items-center justify-center gap-16 px-8" style={{ maxWidth: 960 }}>
        ...
        <div className="w-full max-w-[400px] shrink-0">
          ...
          >
            ...
            <p className="text-[14px] text-center mb-6 leading-relaxed" style={{ color: "var(--muted)" }}>
              Optional. CMK works locally without an account.
              Sign up only if you want sync and dashboard access.
            </p>
          ...
          {/* Legal + sign in link */}
          <p className="text-center text-[12px] mt-4 mb-2" style={{ color: "var(--muted-light)" }}>
      ...
      <style>{`
        ...
        .clerk-auth .cl-signUp-root,
        .clerk-auth .cl-signUp-start {
          width: 100% !important;
        }
